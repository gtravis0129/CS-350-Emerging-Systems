...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ## Turn off the blue light and update the red light
        ##based on the current temp. vs the setpoint
        self.updateLights()
    ...
    def on_exit_heat(self):
        ...
        ##Turn off the red light when leaving the heat state
        redLight.off()
    ...
    def on_enter_cool(self):
        ...
        ##Turn off thered light and update the blue light 
        ##based on the current temp vs setpoint
        self.updateLights()
    ...
    def on_exit_cool(self):
        ...
        ## Turn off the blue light when leaving the cool state
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        ##Trigger the cycle event to move to the next statemachine
        self.cycle()
    ...
    def processTempIncButton(self):
        ...
        ##increase the setpoint by one degree and refresh the lights 
        self.__class__.setPoint = self.setPoint + 1
        self.updateLights()
    ...
    def processTempDecButton(self):
        ...
        ## Decrease the setpoint by 1 degree asd refresh the lights
        self.__class__.setPoint = self.setPoint - 1
        self.updateLights()
    ...
    def updateLights(self):
        ...
        if self.current_state.id == "heat":
            if temp < self.setPoint:
               ## temp is below setpoint  - red LED fades in and out 
               redLight.pulse()
            else:
               ## Temp is at or above setpoint - red LED solid on 
               redLight.on()
       
        elif self.current_state.id == "cool":
            if temp > self.setPoint:
               ## Temp is above setpoint - blue LED fades in and out 
               blueLight.pulse()
            else:
               ## Temp is at or  below setpoint - blue LED solid on 
               blueLight.on()
    ...
    def setupSerialOutput(self):
        ...
        ## build the string with state, temp in F, and setpoint 
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                ## Show the current temp in F
                lcd_line_2 = f"Temp: {floor(self.getFahrenheit())}F"
    
                altCounter = altCounter + 1
            else:
                ##show the current thermostat state and setpoint 
            ...
            if((counter % 30) == 0):
                ...
                ## Send current state info to the TemperatureServer over UART
...
## Assign the cycle function to be triggered when the button is pushed 
...
##
redButton = Button(25)
##Assign the increase setpoint function to be triggered when the button is pushed 
...
##Assign the deccreasae setpoint function to be triggered when the button is pushed 
